        ...
        {isLoading ? (
          ...
          <div className="md:hidden flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory -mx-4 px-4" style={{ scrollbarWidth: "none", WebkitOverflowScrolling: "touch" as any }}>
            {filtered.map((home, i) => (
              <div
                key={home.id}
                className="home-card fade-up card-hover bg-[oklch(0.92_0.08_240)]/80 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-white/40 group flex flex-col cursor-pointer flex-shrink-0 snap-start"
          ...
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {filtered.map((home, i) => (
              <div
                key={home.id}
                className="home-card fade-up card-hover bg-[oklch(0.92_0.08_240)]/80 backdrop-blur-md rounded-2xl overflow-hidden shadow-lg border border-white/40 group flex flex-col cursor-pointer"
              >
                {/* Image */}
                <a
                  href={home.airbnbUrl || "#"}
