...
export default function DesignSection() {
  ...
  return (
    <section id="design" ref={sectionRef} className="py-20 md:py-28 bg-gradient-to-r from-[oklch(0.975_0.012_80)] via-[oklch(0.85_0.12_65)] to-[oklch(0.75_0.15_240)] gradient-animated">
