...
export default function RoomsSection({ hideHeader = false }: { hideHeader?: boolean }) {
  ...
  return (
    <section id="rooms" ref={sectionRef} className={`py-20 md:py-28 bg-gradient-to-r from-[oklch(0.18_0.012_55)] via-[oklch(0.22_0.012_55)] to-[oklch(0.28_0.012_55)] gradient-animated ${hideHeader ? "pt-0" : ""}`}>
