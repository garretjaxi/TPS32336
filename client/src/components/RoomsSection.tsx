...
export default function RoomsSection({ hideHeader = false }: { hideHeader?: boolean }) {
  ...
  return (
    <section id="rooms" ref={sectionRef} className={`py-20 md:py-28 bg-gradient-to-r from-[oklch(0.25_0.18_50)] via-[oklch(0.35_0.18_55)] to-[oklch(0.45_0.18_60)] gradient-animated ${hideHeader ? "pt-0" : ""}`}>
