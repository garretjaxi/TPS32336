...
export default function DesignServices() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[oklch(0.98_0.008_80)] via-[oklch(0.96_0.01_70)] to-[oklch(0.94_0.012_60)] text-[oklch(0.18_0.012_55)]">
      ...
      {/* ── Hero ── */}
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-r from-[oklch(0.12_0.015_240)] to-[oklch(0.15_0.018_235)]">
        <div
      ...
      {/* ── Trust bar ── */}
      <section className="bg-gradient-to-r from-[oklch(0.18_0.012_55)] to-[oklch(0.22_0.015_50)] text-white py-5">
      ...
      <section className="py-20 bg-gradient-to-r from-[oklch(0.98_0.006_75)] to-[oklch(0.95_0.008_70)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-[oklch(0.58_0.14_65)] text-sm font-semibold tracking-widest uppercase mb-3">Gallery</p>
      ...
      {/* ── Why NorthTec ── */}
      <section className="py-20 bg-gradient-to-r from-[oklch(0.12_0.015_240)] to-[oklch(0.15_0.018_235)] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* ── Footer ── */}
      <footer className="bg-gradient-to-r from-[oklch(0.12_0.015_240)] to-[oklch(0.15_0.018_235)] text-white/70 py-10">
