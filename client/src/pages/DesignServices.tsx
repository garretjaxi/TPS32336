...
export default function DesignServices() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[oklch(0.98_0.008_80)] via-[oklch(0.92_0.15_65)] to-[oklch(0.85_0.18_50)] text-[oklch(0.18_0.012_55)]">
      ...
      {/* ── Hero ── */}
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-r from-[oklch(0.25_0.18_50)] via-[oklch(0.35_0.18_55)] to-[oklch(0.45_0.18_60)]">
        <div
      ...
      {/* ── Trust bar ── */}
      <section className="bg-gradient-to-r from-[oklch(0.25_0.18_50)] via-[oklch(0.35_0.18_55)] to-[oklch(0.45_0.18_60)] text-white py-5">
      ...
      <section className="py-20 bg-gradient-to-r from-[oklch(0.98_0.006_75)] via-[oklch(0.92_0.15_65)] to-[oklch(0.85_0.18_50)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-[oklch(0.58_0.14_65)] text-sm font-semibold tracking-widest uppercase mb-3">Gallery</p>
      ...
      {/* ── Why NorthTec ── */}
      <section className="py-20 bg-gradient-to-r from-[oklch(0.25_0.18_50)] via-[oklch(0.35_0.18_55)] to-[oklch(0.45_0.18_60)] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* ── Footer ── */}
      <footer className="bg-gradient-to-r from-[oklch(0.25_0.18_50)] via-[oklch(0.35_0.18_55)] to-[oklch(0.45_0.18_60)] text-white/70 py-10">
