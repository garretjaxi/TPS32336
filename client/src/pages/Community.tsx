...
export default function Community() {
  ...
  return (
    <div className="min-h-screen bg-[oklch(0.98_0.008_80)]">
      <SEO 
        title="Community, Reviews & Latest News"
        description="Read reviews from our happy families and stay up to date with the latest Orlando theme park news and tips."
      />
        ...
        <div className="py-12 bg-[oklch(0.98_0.005_75)]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-[oklch(0.4_0.02_60)] text-lg max-w-2xl mx-auto">
              Join the Theme Park Stays family. Read our latest tips and see what other guests are saying.
            </p>
          </div>
        </div>
