...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[oklch(0.98_0.008_80)] via-[oklch(0.92_0.008_80)] to-[oklch(0.85_0.008_80)] text-[oklch(0.18_0.012_55)] gradient-animated-subtle">
      <SEO 
